...
![](datascience/unnamed-chunk-5-1.png)
...
These boxplots and histograms all show that drafted quarterbacks perform better in college. ![](QBPrediction_files/figure-markdown_github/unnamed-chunk-6-1.png)![](datascience/unnamed-chunk-6-2.png)![](QBPrediction_files/figure-markdown_github/unnamed-chunk-6-3.png)
...
![](datascience/unnamed-chunk-7-1.png) We can see from this summary that the variables used in tree construction are: Yards, Touchdown Percentage, Year, power5, Intercept Percentage, Yards Per Attempt, Intercepts, and Games Played. Additionally, there is a misclassification error rate of 0.143.
...
![](datascience/unnamed-chunk-8-1.png) The pruned tree reduced the number of variables for the model to include: Yards, Yards Per Attempt, Power5, and Attempts. We can see that there is a change on the test error since it is 0.1931.
...
![](datascience/unnamed-chunk-13-1.png)
...
![](datascience/unnamed-chunk-14-1.png)
